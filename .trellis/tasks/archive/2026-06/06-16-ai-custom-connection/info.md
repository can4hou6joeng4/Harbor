...
- 目标端点: `https://sub2api.bobochang.cn`
...
- Cloudflare 差异: Python urllib 曾被 Cloudflare 1010 拦截;App 同款 `URLSession` 与 curl 路径对 `sub2api.bobochang.cn` 可 200 通过,本任务不做 TLS/指纹绕过。
