// icons.jsx — SF-style line icons + helpers (exported to window)
...
const ICON_PATHS = {
  ...
  sidebar: <><rect x="3" y="4.5" width="18" height="15" rx="2.6"/><path d="M9.2 4.7v14.6"/></>,
  ...
  "chev-down": <path d="M5.5 9l6.5 6.5L18.5 9"/>,
  ...
  trash: <path d="M4.5 7h15M9.2 7V5.6A1.6 1.6 0 0 1 10.8 4h2.4a1.6 1.6 0 0 1 1.6 1.6V7M6.6 7l.8 12a1.6 1.6 0 0 0 1.6 1.5h6a1.6 1.6 0 0 0 1.6-1.5l.8-12"/>,
  ...
  "arrow-left": <path d="M11 5l-7 7 7 7M4 12h16"/>,
};
