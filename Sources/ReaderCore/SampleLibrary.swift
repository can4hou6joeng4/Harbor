...
public enum SampleLibrary {
    ...
    private static let seedReferenceDate = Date()

    private static func publishedAt(daysAgo: Int = 0, hoursAgo: Int = 0) -> Date {
        let dateByDay = Calendar.current.date(
            byAdding: .day,
            value: -daysAgo,
            to: seedReferenceDate
        ) ?? seedReferenceDate
        return Calendar.current.date(byAdding: .hour, value: -hoursAgo, to: dateByDay) ?? dateByDay
    }
    ...
    public static let items: [ReaderItem] = [
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(hoursAgo: 3),
            readingTime: 11,
            language: "en",
            tagIDs: ["t-deep", "t-eff"],
            folderID: "fo-product",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 1),
            readingTime: 8,
            language: "zh",
            tagIDs: ["t-ai", "t-eff"],
            folderID: "fo-ai",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 2),
            readingTime: 3,
            language: "en",
            tagIDs: ["t-ai"],
            folderID: "fo-ai",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 4),
            duration: "28:14",
            language: "en",
            tagIDs: ["t-fe"],
            folderID: "fo-fe",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 6),
            readingTime: 2,
            language: "zh",
            tagIDs: ["t-idea"],
            folderID: "fo-product",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 9),
            readingTime: 22,
            language: "en",
            tagIDs: ["t-ai", "t-deep"],
            folderID: "fo-ai",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 10),
            readingTime: 1,
            language: "zh",
            tagIDs: ["t-eff"],
            folderID: "fo-life",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 11),
            readingTime: 9,
            language: "en",
            tagIDs: ["t-ai", "t-deep"],
            folderID: "fo-product",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 12),
            readingTime: 1,
            language: "zh",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 14),
            readingTime: 6,
            language: "zh",
            tagIDs: ["t-eff", "t-fe"],
            folderID: "fo-life",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 16),
            readingTime: 2,
            language: "en",
            tagIDs: ["t-fe", "t-deep"],
            folderID: "fo-fe",
        ...
        ReaderItem(
            ...
            publishedAt: Self.publishedAt(daysAgo: 18),
            duration: "14:52",
            language: "en",
